...
////  Slip-Fi
////
////  Created by Pavel Pavel on 30/07/2025.
////
//
//import SwiftUI
//
//struct SwapViewCopy: View {
...
//                        ForEach(vm.split.results, id: \.parts) { res in
//                            HStack {
//                                Text("\(res.parts)x")
//                                Spacer()
...
//                                let pct  = (res.totalToTokenAmount == 0 || vm.split.results.first?.totalToTokenAmount == 0)
//                                           ? 0.0
...
//                            }
//                            .font(res.parts == (vm.split.best?.parts ?? -1) ? .headline : .body)
//                        }
//
//                        HStack {
//                                Text("Selected parts: \(vm.split.selectedParts)")
//                            Slider(value: Binding(
//                                get: { Double(vm.split.selectedParts) },
//                                set: { vm.split.selectedParts = Int($0) }
//                            ), in: 1...5, step: 1)
//                        }
...
//                }
//                .buttonStyle(.borderedProminent)
//                .disabled(vm.isLoading || vm.split.isRunning)
//                
//                                  if vm.split.isRunning {
//                                if let t = vm.split.total { Text(t).font(.footnote) }
//                                ProgressView(value: Double(vm.splitCurrent), total: Double(max(vm.split.total, 1)))
...
//                        ForEach(vm.split.hashes, id: \.self) { h in
//                            HStack {
